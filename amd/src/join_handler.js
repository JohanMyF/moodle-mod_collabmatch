...
/**
 * Handles joining invited games in CollabMatch.
 *
 * @module     mod_collabmatch/join_handler
        ...
        buttons.forEach(function(button) {
            button.addEventListener('click', function(e) {
                ...
                if (!gameid) {
                    Notification.alert(
                        'CollabMatch',
                        Str.get_string('jsinvalidgameselected', 'mod_collabmatch'),
                ...
                Ajax.call([{
                    ...
                    .then(function(response) {
                        ...
                        return Promise.all([
                            ...
                            Str.get_string('jsgamenotjoined', 'mod_collabmatch'),
                            Str.get_string('ok', 'moodle')
